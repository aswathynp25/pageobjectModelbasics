package com.b2.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "aswathynp04@gmail.com";
	public static String password = "computerscience";
	public static String[] to ={"aswathynp25@gmail.com"};
